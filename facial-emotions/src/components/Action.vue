  ...
  methods: {
    ...
    setResultSize () {
      ...
      */
      ...
      this.output.fillStyle = "#F05454";
      this.output.strokeStyle = "#F05454";
      this.output.lineWidth = 1;
    },
    ...
    420, 363, 361, 401, 288, 265, 372, 353, 390, 339, 249, 339, 448, 255];
      ...
      faces.forEach( face => {
        let percent = Number(face.faceInViewConfidence.toFixed( 1 )*100).toFixed(1);
        percent+="%";
        this.setText( `Detección de Rostro: ${percent}` );
        ...
        for( let i = 0; i < FaceTriangles.length / 3; i++ ) {
            ...
            this.drawTriangle( this.output, pointA[ 0 ], pointA[ 1 ], pointB[ 0 ], pointB[ 1 ], pointC[ 0 ], pointC[ 1 ] );
        }
      });
